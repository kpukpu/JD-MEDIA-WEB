...
const Waves = ({
  ...
  const configRef = useRef({ lineColor, strokeWidth, waveSpeedX, waveSpeedY, waveAmpX, waveAmpY, friction, tension, maxCursorMove, xGap, yGap });
  const frameIdRef = useRef(null);

  useEffect(() => {
    configRef.current = { lineColor, strokeWidth , waveSpeedX, waveSpeedY, waveAmpX, waveAmpY, friction, tension, maxCursorMove, xGap, yGap };
  }, [lineColor , strokeWidth, waveSpeedX, waveSpeedY, waveAmpX, waveAmpY, friction, tension, maxCursorMove, xGap, yGap]);
  ...
  useEffect(() => {
    ...
    function drawLines() {
      ...
      ctx.lineWidth = configRef.current.strokeWidth; 
  ...
  return (
    <div
      ...
      style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", backgroundColor, ...style }}
    >
  ...
  <main className="hero">
    ...
    <div className="hero__bg" aria-hidden="true">
      <Waves
        ...
        lineColor="rgba(58,95,39,.5)" strokeWidth={1}
        backgroundColor="transparent"
        waveSpeedX={0.02}
        waveSpeedY={0.01}
        waveAmpX={28}
      ...
      <svg className="wave" viewBox="0 0 1440 320" preserveAspectRatio="none">
        <path d="M0,160L60,165.3C120,171,240,181,360,176C480,171,600,149,720,160C840,171,960,213,1080,213.3C1200,213,1320,171,1380,149.3L1440,128L1440,320L0,320Z"/>
      </svg>
      <svg className="wave wave--2" viewBox="0 0 1440 320" preserveAspectRatio="none">
        <path d="M0,224L60,197.3C120,171,240,117,360,106.7C480,96,600,128,720,160C840,192,960,224,1080,213.3C1200,203,1320,149,1380,122.7L1440,96L1440,320L0,320Z"/>
      </svg>
    </div>

    {/* 로고 */}
    <img className="hero__logo" src={mainLogo} alt="JD MEDIA Logo" />
